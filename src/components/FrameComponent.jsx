        ...
        <div className="self-stretch flex flex-col items-start justify-start max-w-full text-left text-[1.806rem]">
          <div className="self-stretch h-[41.575rem] flex flex-col items-start justify-start pt-[20rem] px-[0rem] pb-[1.193rem] box-border gap-[0.243rem] shrink-0 max-w-full z-[1] mq1125:h-auto">
            ...
            <div className="self-stretch flex flex-row items-start justify-start gap-[0.562rem] max-w-full mq1125:flex-wrap">
              ...
              />
              <Acess
                access="Investor Networking"
                gainExclusiveAccessToOurI="Engage with a diverse range of investors, from venture capitalists to angel investors, gaining insights into their investment criteria and thought processes. This interaction will help define initial metrics and refining the pitch"
                hoursSupport1="/24hourssupport-5@2x.png"
                propFlex="0.9937"
                propPadding="3.125rem 1.937rem 1.506rem"
                propGap="3.75rem"
              />
              <Acess
                access="Access to Funding"
                gainExclusiveAccessToOurI="Opportunity to secure pre-seed/seed investments of up to $250,000 from the PedalStart network"
                hoursSupport1="/24hourssupport-6@2x.png"
                propFlex="1"
                propPadding="3.125rem 1.875rem 1.506rem"
                propGap="6.375rem"
              />
